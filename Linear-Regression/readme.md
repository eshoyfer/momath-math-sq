...
The challenge of the game is for guests move around the floor so that the line of best fit aligns with a target regression line. 
Once this is matched, a new target is made.
It teaches guests how data cordinates affects the regression line. 
