...
function setupTarget(){
	...
	targetInterceptMin = targetIntercept-THRESHOLD;
	targetInterceptMax = targetIntercept+THRESHOLD;
}
...
// lr.r2
	...
	var interceptInRange = (lr.intercept <= targetY1+THRESHOLD &&  lr.intercept >= targetY1-THRESHOLD);
	//var y3 = lr.slope*x2+lr.intercept;
	//console.log(lr.intercept + targetIntercept);
	//console.log("slope " + slopeInRange);
	//console.log(lr.slope + " --- " + targetSlope);
	//console.log(slopeInRange);
	text2.innerHTML = lr.intercept;
